...
import java.math.*;
 ...
 /**
  * Docentes Value Object.
  * This class is value object representing database table trabvivian
...
public class Docentes implements Cloneable, Serializable {
    ...
    public Docentes (String doc_idIn, String password) {

          this.doc_cod = doc_idIn;
          this.doc_password = password;
    ...
    /** 
     * hasEqualMapping-method will compare two Docentes instances
     * and return true if they contain same values in all persistent instance 
     * variables. If hasEqualMapping returns true, it does not mean the objects
     * are the same instance. However it does mean that in that moment, they 
     * are mapped to the same row in database.
     */
    public boolean hasEqualMapping(Docentes valueObject) {
    ...
    public String toString() {
        ...
        out.append("\nclass Docentes, mapping to table trabvivian\n");
